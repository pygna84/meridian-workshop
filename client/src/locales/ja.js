export default {
  ...
  restocking: {
    title: '補充推奨',
    subtitle: '在庫レベル、需要予測、予算に基づく推奨発注',
    budgetLabel: '予算上限',
    budgetPlaceholder: '上限なし',
    generate: '推奨を生成',
    summaryItems: '予算内の品目数',
    summaryCost: '見積コスト',
    summaryDeferred: '保留（予算超過）',
    summaryUnused: '残予算',
    recommendedHeading: '推奨発注',
    deferredHeading: '保留 — 予算超過',
    sku: 'SKU',
    item: '品目',
    category: 'カテゴリ',
    warehouse: '倉庫',
    ...
    estCost: '見積額',
    priority: '優先度',
    nothingToRestock: '現在のフィルターでは再注文点を下回る品目はありません。',
    deferredEmpty: '全項目が予算内に収まります。',
    forecastLift: '予測上乗せ +{qty}',
    action: 'アクション',
    createPo: '発注作成',
    poCreated: '発注済み',
    modal: {
      ...
      notes: '備考（任意）',
      notesPlaceholder: '受領チームへの連絡事項',
      submit: '発注書を作成',
      cancel: 'キャンセル',
      submitting: '作成中...',
      successTitle: '発注書を作成しました',
      successBody: 'PO {id} を {supplier} 宛に {qty} 単位で発行しました。',
      errorTitle: '発注書の作成に失敗しました'
    }
  },
