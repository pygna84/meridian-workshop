export default {
  ...
  restocking: {
    ...
    subtitle: 'Recommended purchase orders based on stock levels, demand forecast, and your budget',
    budgetLabel: 'Budget ceiling',
    budgetPlaceholder: 'No limit',
    generate: 'Generate Recommendations',
    summaryItems: 'Items in budget',
    summaryCost: 'Estimated cost',
    summaryDeferred: 'Deferred (over budget)',
    summaryUnused: 'Remaining budget',
    recommendedHeading: 'Recommended Orders',
    deferredHeading: 'Deferred — Over Budget',
    sku: 'SKU',
    item: 'Item',
    category: 'Category',
    warehouse: 'Warehouse',
    ...
    estCost: 'Est. Cost',
    priority: 'Priority',
    nothingToRestock: 'All items above reorder point — no restocking needed for the current filters.',
    deferredEmpty: 'Everything fits inside the budget.',
    forecastLift: 'forecast lift +{qty}',
    action: 'Action',
    createPo: 'Create PO',
    ...
    modal: {
      ...
      notesPlaceholder: 'Anything the receiving team should know',
      submit: 'Create Purchase Order',
      cancel: 'Cancel',
      submitting: 'Creating...',
      successTitle: 'Purchase order created',
      successBody: 'PO {id} sent to {supplier} for {qty} units.',
      errorTitle: 'Could not create purchase order'
    }
  },
